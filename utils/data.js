export const data = {
  products: [
    ...
    },
    {
      ...
      description:
        'With a "BASEBALL" graphic on soft cotton, this Nike T-shirt nods to your favorite sport while turning up the comfort—wherever your active lifestyle takes you.',
      color: ['red'],
      sizes: [
    ...
    },
    {
      ...
      images: [
        ...
        'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/77d83b7a-08d3-4c7c-9641-23b30a1be548/sportswear-swoosh-mens-t-shirt-LzncrX.png',
      ],
      description:
        'Big and bold, the Nike Sportswear T-Shirt offers soft cotton construction and a prominent graphic at the chest.',
      color: ['peach'],
      sizes: [
        { size: 'small', quantity: 0 },
        { size: 'medium', quantity: 1 },
    ...
    },
    {
      ...
      images: [
        ...
        'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/e76b1076-c09d-41fa-86a2-33c30a46b278/sportswear-swoosh-mens-t-shirt-LzncrX.png',
      ],
      description:
        'Big and bold, the Nike Sportswear T-Shirt offers soft cotton construction and a prominent graphic at the chest.',
      color: ['cream'],
    ...
    },
    {
      ...
      images: [
        ...
        'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/b8f43745-51fa-43a7-bb0a-a0284fccd4cd/sportswear-mens-classic-fleece-pants-DgDCHh.png',
        'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/986a4cd8-e00f-44df-8e12-614fc35b47d8/sportswear-mens-classic-fleece-pants-DgDCHh.png',
      ],
      description:
        'The Nike Sportswear Pants are a closet staple made with heavyweight semi-brushed fleece, tall ribbed cuffs and tonal detailing (on select colorways). An elastic waist and flat drawcord let you personalize the fit. Side pockets and a back pocket offer quick storage for your phone keys and cards.',
      color: ['blue'],
      sizes: [
        { size: 'small', quantity: 0 },
        { size: 'medium', quantity: 0 },
    ...
    },
    {
      ...
      images: [
        ...
        'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/1b308015-3b56-4cb1-8209-dac3f7e856f2/sportswear-mens-classic-fleece-pants-DgDCHh.png',
        'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/ab2adc97-022a-4f6f-93ab-94c38fc0b063/sportswear-mens-classic-fleece-pants-DgDCHh.png',
      ],
      description:
        'The Nike Sportswear Pants are a closet staple made with heavyweight semi-brushed fleece, tall ribbed cuffs and tonal detailing (on select colorways). An elastic waist and flat drawcord let you personalize the fit. Side pockets and a back pocket offer quick storage for your phone keys and cards.',
      color: ['orange'],
    ...
    },
    {
      ...
      images: [
        ...
        'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/8b178c4d-b36c-4459-9953-c41afacf30d9/sportswear-mens-classic-fleece-pants-DgDCHh.png',
      ],
      description:
        'The Nike Sportswear Pants are a closet staple made with heavyweight semi-brushed fleece, tall ribbed cuffs and tonal detailing (on select colorways). An elastic waist and flat drawcord let you personalize the fit. Side pockets and a back pocket offer quick storage for your phone keys and cards.',
      color: ['yellow'],
